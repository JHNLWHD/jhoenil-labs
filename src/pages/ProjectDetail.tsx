...
const ProjectDetail = () => {
  ...
  useEffect(() => {
    ...
    setMeta('meta[property="og:image"]', `${siteConfig.url}${project.image}`);
    setMeta('meta[property="og:image:alt"]', `${project.title} preview`);
    setMeta('meta[name="twitter:title"]', title);
    setMeta('meta[name="twitter:description"]', description);
    setMeta('meta[name="twitter:image"]', `${siteConfig.url}${project.image}`);
