      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <h2 id="about-heading" className="text-3xl font-bold mb-6">Turning Complex Problems Into Elegant and Simple Solutions</h2>
            <p className="text-gray-700 mb-4">
              With over 5 years of experience in software engineering and technical consulting, I've helped startups, agencies, and enterprises build and scale their digital products.
            </p>
            <p className="text-gray-700 mb-4">
